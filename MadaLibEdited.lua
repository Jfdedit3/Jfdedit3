...
function MADA:Theme(name)
	name = tostring(name or "dark"):lower()
	if name == "original" then
		MADA.Themes.BlackgroundColor = Color3.fromRGB(0, 0, 0)
		MADA.Themes.BlackColor = Color3.fromRGB(8, 8, 8)
		MADA.Themes.HeaderColor = Color3.fromRGB(8, 8, 8)
		MADA.Themes.TraceColor = Color3.fromRGB(25, 25, 25)
		MADA.Themes.MainColor = Color3.fromRGB(0, 172, 247)
		MADA.Themes.MainColorDrop = Color3.fromRGB(64, 65, 67)
		MADA.Themes.SectionColor = Color3.fromRGB(10, 11, 13)
		MADA.Themes.StrokeColor = Color3.fromRGB(28, 28, 28)
		MADA.Themes.ButtonBlackgroundColor = Color3.fromRGB(13, 13, 13)
	end

	if name == "nightly" then
		MADA.Themes.BlackgroundColor = Color3.fromRGB(37, 37, 37)
		MADA.Themes.BlackColor = Color3.fromRGB(8, 8, 8)
		MADA.Themes.HeaderColor = Color3.fromRGB(8, 8, 8)
		MADA.Themes.TraceColor = Color3.fromRGB(25, 25, 25)
		MADA.Themes.MainColor = Color3.fromRGB(0, 172, 247)
	...
	if name == "dark" then
		MADA.Themes.BlackgroundColor = Color3.fromRGB(22, 22, 22)
		MADA.Themes.BlackColor = Color3.fromRGB(8, 8, 8)
		MADA.Themes.HeaderColor = Color3.fromRGB(8, 8, 8)
		MADA.Themes.TraceColor = Color3.fromRGB(25, 25, 25)
		MADA.Themes.MainColor = Color3.fromRGB(0, 172, 247)
...
function MADA:AddWindow(NameScriptHub,Text,UICustomSize)
	...
	task.spawn(function()
		if Text then
			...
			TextLabel.Text = Text or"MADA UI"
	...
	local function ui_toggleong(val)
		local uptime=1.4
		if val then
			TweenService:Create(Frame,TweenInfo.new(uptime,Enum.EasingStyle.Quint),{Size=ooldsize,Position=UDim2.new(0.3,0,0.5,0)}):Play()
	...
	Frame.BackgroundColor3 = MADA.Themes.BlackgroundColor
...
viewportFrame.MouseLeave:Connect(function()
	...
	Frame_2.BackgroundColor3 = MADA.Themes.BlackColor
	...
	Frame_3.BackgroundColor3 = MADA.Themes.HeaderColor
	...
	HeadName.ZIndex = 4
	HeadName.Font = Enum.Font.FredokaOne
	HeadName.Text = NameScriptHub or "MADA"
	...
	outlo.BackgroundColor3 = MADA.Themes.TraceColor
	...
	outlo_2.BackgroundColor3 = MADA.Themes.TraceColor
	...
	outlo_3.BackgroundColor3 = MADA.Themes.TraceColor
...
ob.MouseButton1Click:Connect(function()
	...
	function WindowFunctinos:AddTab(TabNameString,IconType)
		...
		local cc = MADA.Themes.MainColor

		if cc == Color3.fromRGB(0, 172, 247) then
			cc = MADA.Themes.BlackgroundColor
		end
		...
		Image.ImageColor3 = MADA.Themes.MainColor
		Image.ImageRectOffset = Vector2.new(205, 565)
		Image.ImageRectSize = Vector2.new(35, 35)
		...
		function TabFunctions:AddSection(SectionName,parentname)
			...
			Section.BackgroundColor3 = MADA.Themes.SectionColor
			...
			UIStroke.Color = MADA.Themes.StrokeColor
			...
			lay.Name = "lay"
			lay.Parent = Section
			lay.BackgroundColor3 = MADA.Themes.StrokeColor
			...
			table.insert(MADA.auto_function,update_section_size)
			...
			function sectionfunc:AddButton(ButtonName,callback)
				...
				Button.BackgroundColor3 = MADA.Themes.ButtonBlackgroundColor
			...
			function sectionfunc:AddLabel(LabelNameString)
				...
				LabelText.BorderSizePixel = 0
				LabelText.Position = UDim2.new(0.5, 0, 0.5, 0)
				LabelText.Size = UDim2.new(1, -2, 0.649999976, -2)
				LabelText.ZIndex = 6
				LabelText.Font = Enum.Font.SourceSansSemibold
			...
			function sectionfunc:AddToggle(ToggleName,Default,callback)
				...
				local function toggleval(val,timea)
					if val then
						...
						TweenService:Create(Icon,TweenInfo.new(timea),{Position=UDim2.new(0.75,0,0.5,0),BackgroundColor3=MADA.Themes.MainColor}):Play();
			...
			function sectionfunc:AddSlider(SliderNameString,Min,Max,Default,callback)
				...
				Box.BackgroundColor3 = MADA.Themes.ButtonBlackgroundColor
				...
				MoveFrame.BackgroundColor3 = MADA.Themes.MainColorDrop
				...
				Inline.BackgroundColor3 = MADA.Themes.MainColor
				...
				Cir.BackgroundColor3 = MADA.Themes.MainColor
			...
			function sectionfunc:AddDropdown(DropdownName,data,Default,callback)
				...
				TopBar.BackgroundColor3 = MADA.Themes.ButtonBlackgroundColor
				...
				UIStroke_2.Color = MADA.Themes.StrokeColor
				...
				table.insert(MADA.auto_function,auto_updatea)
				refresh()
...
function MADA:KeySystem(TitleName,LinkKey,callback)
	local Functions = {}
	...
	PasteKey.BackgroundColor3 = MADA.Themes.ButtonBlackgroundColor
	...
	CopyKey.BackgroundColor3 = MADA.Themes.ButtonBlackgroundColor
	...
	Submit.Name = "Submit"
	Submit.Parent = Frame
	Submit.BackgroundColor3 = MADA.Themes.ButtonBlackgroundColor
	...
	UIStroke_3.Color = MADA.Themes.StrokeColor
...
function MADA:Notification()
	...
	function Notification_:Notify(Type,Head,Body,countdown)
		...
		Notify.BackgroundColor3 = MADA.Themes.SectionColor
		...
		IconImage.ImageColor3=MADA.Themes.MainColor
		...
		Countdown.BackgroundColor3 = MADA.Themes.MainColor
...
task.spawn(function()
	_G.index_MADA=true
	while _G.index_MADA do task.wait(0)
		pcall(function()
			for i,v in ipairs(MADA.auto_function) do task.wait()
				pcall(function()
					task.spawn(v)
				end)
			end
